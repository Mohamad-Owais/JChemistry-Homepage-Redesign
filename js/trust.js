 ...
 * Handles FAQ accordion, testimonial rendering, and trust counters.
 */
...
const JChemTrust = {
  ...
  testimonials: [
    {
      initial: "P",
      name: "Priya Sharma",
      course: "CSIR-NET Complete Batch",
      review:
        "The structured approach and daily practice tests made a huge difference. Cleared CSIR-NET in my first attempt with JRF rank!",
    },
    {
      initial: "A",
      name: "Arjun Mehta",
      ...
      review:
        "Dr. Kumar's teaching style is exceptional. Complex physical chemistry topics became very clear. Secured GATE rank under 200.",
    },
    {
      initial: "S",
      name: "Sneha Patel",
      course: "IIT-JAM Prep",
      review:
        "Highly recommended for IIT-JAM aspirants. The notes are concise and the mock tests are very close to the actual exam pattern.",
    },
    {
      initial: "R",
      name: "Rahul Nair",
      ...
      review:
        "Best organic chemistry course I found. Reaction mechanisms are explained with absolute clarity. No rote learning, just concepts.",
    },
    {
      initial: "M",
      name: "Meera Joshi",
      course: "CSIR-NET Complete Batch",
      review:
        "The doubt resolution system is excellent. My queries were answered within a day. Passed CSIR-NET with a comfortable margin.",
    },
    {
      initial: "D",
      name: "Deepak Singh",
      course: "GATE Chemistry",
      review:
        "The study material quality is top-notch. It covers every corner of the GATE syllabus without any unnecessary padding.",
    },
  ],
  ...
  results: [
    {
      ...
      course: "CSIR-NET Complete Batch",
      quote:
        "JChemistry gave me the direction I needed. The structured syllabus coverage changed everything.",
      photo: "",
    },
    {
      initial: "K",
      ...
      exam: "GATE CY",
      rank: "AIR 47",
      course: "GATE Chemistry Focus",
      quote:
        "From struggling with physical chemistry to cracking GATE — it was JChemistry that made it possible.",
      photo: "",
    },
    {
      initial: "N",
      name: "Neha Gupta",
      exam: "IIT-JAM",
      rank: "IIT Bombay Admitted",
      course: "IIT-JAM Complete Prep",
      quote:
        "The mock tests were indistinguishable from the real exam. I felt completely prepared on exam day.",
      photo: "",
    },
    {
      initial: "V",
      ...
      quote:
        "Exceptional study material and faculty support. Could not have done it without JChemistry.",
      photo: "",
    },
    {
      initial: "T",
      ...
      quote:
        "The inorganic chemistry module alone was worth the entire course fee. Highly detailed and precise.",
      photo: "",
    },
    {
      initial: "S",
      name: "Suresh Kumar",
      exam: "IIT-JAM",
      rank: "IIT Delhi Admitted",
      course: "IIT-JAM Complete Prep",
      quote:
        "I joined just 4 months before the exam. The fast-track batch covered everything I needed.",
      photo: "",
    },
  ],

  starsSvg:
    `<svg viewBox="0 0 24 24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>`.repeat(
      5,
    ),

  animateCountUp(element, duration = 1400) {
    if (!element) return;
    ...
    const hasStar = rawValue.includes("★");
    const suffix = hasStar ? " ★" : hasPlus ? "+" : "";
    ...
    const tick = (now) => {
      ...
      if (progress < 1) {
        ...
        element.textContent = `${formatter.format(numericValue)}${suffix}`;
      }
    };
  ...
  syncHeroTrustSpacing() {
    const hero = document.querySelector(".hero");
    const trustBar = document.querySelector(".trust-bar");
    const header = document.querySelector(".header-main");
    if (!hero || !trustBar || !header) return;

    const update = () => {
      const trustHeight = Math.round(trustBar.getBoundingClientRect().height);
      ...
      if (window.innerWidth >= 1024) {
        ...
        const availableHeight = Math.max(
          window.innerHeight - headerHeight - trustHeight,
          0,
        );
  ...
  initTrustCounters() {
    ...
    const values = document.querySelectorAll(".trust-card__value");
    if (!trustSection || !values.length) return;

    const startAnimation = () => {
      values.forEach((value) => this.animateCountUp(value));
    };
  ...
  renderTestimonials() {
    ...
    const cardsHtml = this.testimonials
      .map(
        (t) => `
